            ...
            <div class="py-3 d-flex align-items-sm-center flex-sm-row flex-column">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="border-bottom: none;">
                    ...
                    <img src="{{ asset('assets/icons/icon.svg') }}" alt="Truck Icon"
                        style="width: 40px; height: 40px; margin-right: 8px; cursor: pointer;" onclick="toggleDropdown()" />
                        ...
                        <div class="row">
                            @foreach ($documents as $document)
                                <div class="mb-4 col-sm-6 col-xl-4">
                                    <div class="overflow-hidden border-0 shadow-lg card rounded-4 position-relative"
                                        style="border-top-right-radius: 3rem;">
                                        @php
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p class="mb-3 text-muted small">Edited
                                            ...
                                            @else
                                                <div class="overflow-hidden rounded"
                                                    style="height: 200px; background-color: #f4f4f4;">
                                                    <img src="{{ asset('images/placeholder-doc.png') }}"
                                                        class="w-100 h-100 object-fit-cover" alt="Doc preview"
                                                        style="opacity: 0.6;">
                                                </div>
                                            @endif
                                        </div>
