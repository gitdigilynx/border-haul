                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="p-4 mb-0 border-0 p-md-5 p-lg-0">
                                            ...
                                            <div class="mb-3 text-center auth-title-section">
                                                ...
                                                <p class="mb-0 text-dark fs-14 text-uppercase">Charrier Log In</p>
                                            </div>

                                            @include('backend.components.alerts.errors.errors')
                                            ...
                                            <div class="pt-0">
                                                ...
                                                <div class="text-center text-muted mb-7">
                                                    <p class="mb-0">Don't have an Shipper account ?<a class='text-primary ms-2 fw-medium' href='{{ route('register') }}'>Create Account</a></p>
